...
internal struct DPDConstant {
	...
	internal struct UI {
        ...
        static let TextFont = UIFont.MontserratFont(size: (UIDevice.current.userInterfaceIdiom == .pad) ? 20.0 : 16.0, weight: .Medium)
        static let BackgroundColor = UIColor.init(hexString: colors.lightgraybgColor)//UIColor(white: 0.94, alpha: 1)
		static let SelectionBackgroundColor = UIColor(white: 0.89, alpha: 1)
		static let SeparatorColor = UIColor.clear
		static let CornerRadius: CGFloat = 2
		static let RowHeight: CGFloat = (UIDevice.current.userInterfaceIdiom == .pad) ? 60 : 50

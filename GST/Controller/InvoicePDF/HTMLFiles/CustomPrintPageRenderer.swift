...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    /*override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
        ...
        let textAttributes = [NSAttributedStringKey.font: font, NSAttributedStringKey.backgroundColor: UIColor(red: 243.0/255, green: 82.0/255.0, blue: 30.0/255.0, alpha: 1.0)] as [NSAttributedStringKey : Any]
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        let attributes = [NSAttributedStringKey.font: font, NSAttributedStringKey.backgroundColor: UIColor(red: 205.0/255.0, green: 205.0/255.0, blue: 205.0/255, alpha: 1.0)]
    ...
    func getTextSize(text: String, font: UIFont!, textAttributes: [String: AnyObject]! = nil) -> CGSize {
        ...
        if let attributes = textAttributes {
            testLabel.attributedText = NSAttributedString(string: text, attributes: attributes) as [NSAttributedStringKey : Any]
        }
        else {
            testLabel.text = text
            testLabel.font = font!
